...
class ViewToolbar extends React.Component {
    ...
    render(){
        return (
            React.createElement("div", {id: "toolbar", className: "card"}, 
